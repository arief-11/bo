<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-md-10">
				<h1 class="m-0 text-dark">Analisa Bimbingan</h1>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container-fluid">
		...
		<?php
			foreach ($data as $z) {
				...
				$makul = $z->id_makul;
				$query = $this->db->query("SELECT *, mahasiswa.nama mahasiswa, dosen.nama dosen FROM ploting JOIN mahasiswa ON ploting.id_mahasiswa = mahasiswa.id_mahasiswa JOIN pembimbing ON ploting.id_pembimbing = pembimbing.id_pembimbing JOIN dosen ON pembimbing.id_dosen = dosen.id_dosen WHERE mahasiswa.id_jurusan = '$jurusan' && id_makul = '$makul' ORDER BY mahasiswa.nama")->result();
				$data2 = [];
					...
					<table class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th rowspan="2" class="align-middle">Dosbing</th>

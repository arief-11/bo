<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-md-12">
				<h1 class="m-0 text-dark">Riwayat Bimbingan</h1>
			</div>
		</div>
	</div>
</div>
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-3" style="font-weight: 600;">
						Nama Mahasiswa<span style="float: right;">:</span>
					</div>
					<div class="col-md-9">
						<?= $mahasiswa->nama ?>
					</div>
				...
				<div class="row">
					<div class="col-md-3" style="font-weight: 600;">
						Jurusan<span style="float: right;">:</span>
					</div>
					<div class="col-md-9">
						<?= $mahasiswa->jurusan ?>
					</div>
				...
				<div class="row">
					<div class="col-md-3" style="font-weight: 600;">
						Mata Kuliah<span style="float: right;">:</span>
					</div>
					<div class="col-md-9">
						<?= $makul ?>
					</div>
				...
				<div class="row">
					<div class="col-md-3" style="font-weight: 600;">
						Dosen Pembimbig<span style="float: right;">:</span>
					</div>
					<div class="col-md-9">
						<?= $dosbing ?>
					</div>
